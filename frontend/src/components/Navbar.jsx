...
const Navbar = () => {
    ...
    return (
        <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'glass-panel py-3' : 'bg-white/50 backdrop-blur-sm py-4 border-b border-transparent'}`}>
                ...
                <div className="flex items-center gap-4">
                    {user ? (
                        ...
                        <div className="flex gap-3">
                            ...
                            <Link to="/signup" className="px-5 py-2 text-sm font-semibold text-white bg-primary-500 rounded-xl hover:bg-primary-600 shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all">
                                Sign up
                            </Link>
                        </div>
                    )}
